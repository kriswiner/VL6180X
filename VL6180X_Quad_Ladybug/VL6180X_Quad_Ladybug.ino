...
uint8_t Seconds, Minutes, Hours, Day, Month, Year;
volatile bool alarmFlag = false, intFlag0 = false, intFlag1 = false, intFlag2 = false, intFlag3 = false;
